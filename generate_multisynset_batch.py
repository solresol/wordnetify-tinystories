...
parser.add_argument("--output-file", default='multisynset_batch_output.jsonl', help="Where to put the batch file")
...
try:
    ...
    sys.exit(f"Failed to open the output file ({{args.output_file}}): {{e}}")
